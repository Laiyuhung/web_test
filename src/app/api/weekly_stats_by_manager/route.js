      ...
      for (const [name, dates] of Object.entries(players)) {
        ...
        if (isBatter) {
          ...
          for (const date of dates) {
            ...
            console.log(`📅 Manager ${managerId} / ${name} 打者 @ ${date}:`, rows)
            for (const r of rows) {
          ...
          console.log(`🟦 Manager ${managerId} / ${name} 打者數據加總:`, batterSum)
        }
        ...
        if (isPitcher) {
          ...
          for (const date of dates) {
            ...
            console.log(`📅 Manager ${managerId} / ${name} 投手 @ ${date}:`, rows)
            for (const r of rows) {
          ...
          console.log(`🟥 Manager ${managerId} / ${name} 投手數據加總:`, pitcherSum)
        }
      }
    }
